						...
						for ($z=0; $z < 16; $z++) { 
							for ($y=0; $y < 64; $y++) { 
								if ($x < 4 OR $z < 4) {
									...
									$this->chunk1->setBlockId($x, $y, $z, Block::STONE);//草方块
								}else{
						...
						for ($z=0; $z < 16; $z++) { 
							for ($y=0; $y < 64; $y++) { 
								if ($x < 4) {
									...
									$this->chunk2->setBlockId($x, $y, $z, Block::STONE);//草方块
								}else{
						...
						for ($z=0; $z < 16; $z++) { 
							for ($y=0; $y < 64; $y++) { 
								if ($x < 4 OR $z > 11) {
									...
									$this->chunk3->setBlockId($x, $y, $z, Block::STONE);//草方块
								}else{
						...
						for ($z=0; $z < 16; $z++) { 
							for ($y=0; $y < 64; $y++) { 
								if ($z < 4) {
									...
									$this->chunk4->setBlockId($x, $y, $z, Block::STONE);//草方块
								}else{
						...
						for ($z=0; $z < 16; $z++) { 
							for ($y=0; $y < 64; $y++) { 
								if ($x > 11 OR $z < 4) {
									...
									$this->chunk5->setBlockId($x, $y, $z, Block::STONE);//草方块
								}else{
						...
						for ($z=0; $z < 16; $z++) { 
							for ($y=0; $y < 64; $y++) { 
								if ($x > 11) {
									...
									$this->chunk6->setBlockId($x, $y, $z, Block::STONE);//草方块
								}else{
						...
						for ($z=0; $z < 16; $z++) { 
							for ($y=0; $y < 64; $y++) { 
								if ($x > 11 OR $z > 11) {
									...
									$this->chunk7->setBlockId($x, $y, $z, Block::STONE);//草方块
								}else{
						...
						for ($z=0; $z < 16; $z++) { 
							for ($y=0; $y < 64; $y++) { 
								if ($z > 11) {
									...
									$this->chunk8->setBlockId($x, $y, $z, Block::STONE);//草方块
								}else{
			...
			default:
				if ($this->chunk9 === null) {
					...
					for ($x=0; $x < 16; $x++) { 
						for ($z=0; $z < 16; $z++) { 
							for ($y=0; $y < 64; $y++) { 
								$this->chunk9->setBlockId($x, $y, $z, Block::STONE);//草方块
							}
						}
					}
				}
