...
class WMultiWorld extends PluginBase implements Listener 
{
    public function onEnable() 
    {
		...
		"manager" => array(),
		"tp-msg" => "§2▎§f你被传送到了世界 {world}",
		"noexist-msg" => "§4▎§f对不起，世界 {world} 不存在！",
		"noname-msg" => "§9▎§f请输入一个地图名",
		"notplayer-msg" => "§e▎§f请在游戏内输入传送指令！",
		"chat-tp" => array(),
		"item-touch"=>array(259,325,351,291,292,293,294),
		"protect-world" => array(),
		"protect-msg" => "§4▎§c对不起，这个世界被保护了！",
		"banpvp-world" => array(),
		"op-pvp" => "false",
		"world-create" => array(),
		"whitelist-world" => array(),
		"wl-list" => array(),
		"pvp-msg" => "§e▎§f玩家信息%n§aID: {name}%n§7▎§b金钱: {money}%n§f▎§b饥饿值: {food}%n§f▎§b血量: [{hp}/{mhp}]%n§f▎§b权限: {isop}"
		));
